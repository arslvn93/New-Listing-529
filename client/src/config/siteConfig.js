...
export const openHouseDetails = {
  nextDate: "Friday, September 12, 2025",
...
export const property = {
  ...
  heroCaption: "Floor-to-Ceiling Glass + Renovated Kitchen + Bright SE Exposure = Your Perfect Luxury Condo Just Listed!"
};
...
export const siteMetadata = {
  ...
  description: "Floor-to-Ceiling Glass + Renovated Kitchen + Bright SE Exposure = Your Perfect Luxury Condo Just Listed!",
